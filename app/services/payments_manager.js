const payments_manager = require('@adopisoft/core/payments-manager')
const coinslots_manager = require('@adopisoft/core/coinslots-manager')
...
exports.que = async (opts) => {
  ...
  if (!payments_manager.isCoinslotAvailable(coinslot_id)) {
    return Promise.reject('toast.error.SOMEONE_IS_PAYING')
  }
  if (device.is_suspended) {
    return Promise.reject('toast.error.PAYMENT_RETRIES_REACHED')
  }
